...
public class HttpRequest1 {
    ...
    private static String host = "http://10.10.134.38:8080/mvc";
//    private static String host = "http://10.10.134.50:8080/4a";
//    private static String host = "http://192.171.1.53:8080/4a";
    ...
    public static Resp doPost(String uri, Map params) {
        ...
        try {
            ...
            resp.code = connection.getResponseCode();
            resp.message = connection.getHeaderField("message");
