...
public class MD5 {
    ...
    public final static String digestToHex(char[] data) {
        try {
    ...
    public final static String digestToHex(byte[] data) {
        try {
            MessageDigest mdInst = MessageDigest.getInstance("MD5");
    ...
    public final static String digestToBase64(char[] data) {
        try {
            byte [] byteData = getBytes(data);
            MessageDigest mdInst = MessageDigest.getInstance("MD5");
            byte[] md = mdInst.digest(byteData);
    ...
    public final static String digestToBase64(byte[] data) {
        try {
            MessageDigest mdInst = MessageDigest.getInstance("MD5");
            byte[] md = mdInst.digest(data);
            return new String(Base64.encode(md));
